...
public class JSONGenerator {
    ...
    public File createJSON() {
        ...
        User testUser = User.builder().firstName("Test").lastName("User").loginName("testUser").password(passwordencoder.encode("test")).userRights(UserRights.ROLE_ADMIN).build();

...
public class DatabaseFiller {
    ...
    public File createJSON() {
        ...
        de.hsrm.mi.swtpro.backend.model.Module mProgrammieren1 = de.hsrm.mi.swtpro.backend.model.Module.builder().title("Programmieren 1").creditPoints(5).period(1).build();
        entityManager.persist(mProgrammieren1);
        de.hsrm.mi.swtpro.backend.model.Module mProgrammieren2 = de.hsrm.mi.swtpro.backend.model.Module.builder().title("Programmieren 2").creditPoints(5).period(1).build();
        entityManager.persist(mProgrammieren2);
        de.hsrm.mi.swtpro.backend.model.Module mProgrammieren3 = de.hsrm.mi.swtpro.backend.model.Module.builder().title("Programmieren 3").creditPoints(5).period(1).build();
        entityManager.persist(mProgrammieren3);
        de.hsrm.mi.swtpro.backend.model.Module mMathe1 = de.hsrm.mi.swtpro.backend.model.Module.builder().title("Mathe 1").creditPoints(5).period(1).build();
        entityManager.persist(mMathe1);
        de.hsrm.mi.swtpro.backend.model.Module mMathe2 = de.hsrm.mi.swtpro.backend.model.Module.builder().title("Mathe 2").creditPoints(5).period(2).build();
        entityManager.persist(mMathe2);
        de.hsrm.mi.swtpro.backend.model.Module mMathe3 = Module.builder().title("Mathe 3").creditPoints(5).period(3).build();

...
public class StudentPassedExamTest {
    ...
    public void whenGetStudent_thenReturnStudent(){
        assertEquals(178642,studentPassedExam.getStudent().getEnrollmentNumber());
    }
    ...
    public void whenSetStudent_thenSaveStudent(){
        Student student = Student.builder()
                .enrollmentNumber(222222)
                .build();
        studentPassedExam.setStudent(student);

        assertEquals(222222,studentPassedExam.getStudent().getEnrollmentNumber());
    }
